...
## dod
- [ ] All Vercel-related files removed from repository
- [ ] README.md updated without Vercel references
- [ ] services/pool_service.py cleaned of Vercel references
- [ ] Dockerfile created and working
- [ ] GitHub Actions workflow for GHCR deployment created
- [ ] Bot successfully runs in Docker container locally
- [ ] Unit tests pass
- [ ] Bot deployed and verified bot startup in Docker
