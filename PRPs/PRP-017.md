...
- [ ] `tests/e2e/test_admin_lesson_agentic.py` - FUTURE WORK (not blocking MVP)
  - Can be added after production validation
...
- LLM prompt role-awareness (optional enhancement)
- E2E test with LLM judge for conversational lesson management
- Production validation in Telegram
- Deploy to production and test with real admin
