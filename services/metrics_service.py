...
class MetricsService:
    ...
    def get_prometheus_metrics(self) -> str:
        ...
        active_users = len([
            uid for uid, last_seen in self.user_activity.items()
        ...
        for command_type, count in self.command_types.items():
            metrics.append(f'dcmaidbot_command_type_count{{command_type="{command_type}"}} {count}')

        metrics.append("")
        metrics.append("# HELP dcmaidbot_last_command_timestamp Unix timestamp of last command")
