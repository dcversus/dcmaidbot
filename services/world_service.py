...
class WorldService:
    ...
    def generate_world(self, width: int, height: int, world_id: str = None) -> Dict[str, Any]:
    ...
    def _select_terrain(self, x: int, y: int, width: int, height: int,
                       terrain: List[List[str]]) -> str:
    ...
    def _get_neighbors(self, x: int, y: int, width: int, height: int,
    ...
    def _find_spawn_point(self, terrain: List[List[str]], width: int, height: int) -> Tuple[int, int]:
