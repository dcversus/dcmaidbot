...
class TelegramService(MessengerService):
    ...
    async def send_rich_content(
        ...
        # TODO: Import bot instance properly - this needs to be fixed
        # from bot import bot  # Import existing bot instance

        try:
            # TODO: Fix bot instance import before using this functionality
            # This function is disabled until bot import is properly implemented
            return {
                "status": "error",
                "error": "Messenger service not properly configured - bot instance missing",
                "requires_fix": True,
            }
    ...
    def __init__(self):
        ...
        try:
            from core.services.discord_service import (
                DiscordService as DiscordServiceImpl,
            )
