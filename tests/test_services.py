...
def test_add_participant(setup_test_storage):
    ...
    pool_service.create_pool("test_pool", [Participant(user_id=1, username="user1")])
...
def test_get_pools_by_participant(setup_test_storage):
    ...
    pool_service.create_pool("pool3", [Participant(user_id=3, username="user3")])
...
def test_add_activity(setup_test_storage):
    ...
    activity_by_stranger = Activity(
        content="Activity by stranger", added_by=999, added_at=datetime.now()
    )
...
def test_select_activity(setup_test_storage):
    ...
    pool_service.create_pool("test_pool2", [Participant(user_id=1, username="user1")])
