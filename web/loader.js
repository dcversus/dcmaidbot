...
export class AssetLoader {
    ...
    async loadWidgetOverlays(floorId, locId, widgets) {
        ...
        for (const widget of widgets) {
            for (const state of widget.states) {
                ...
                loadingPromises.push(this.loadImage(overlayUrl)
                    .then(img => {
